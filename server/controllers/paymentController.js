...
exports.list = function(req, res) {
    sequelize.query('select p.intent, p.payment_method, p.payment_id, o.Order_id as order_id, p.currency, p.description from Payments p join Orders o on p.order_id = o.Order_id', 
